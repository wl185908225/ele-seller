<template>
    <div>
            ...
            <div class="foods-wrapper" ref="foodswrapper">
                <ul>
                    <li class="food-list food-list-hook" v-for="(item, index) in goods" :key="index">
                        ...
                        <ul>
                            <li class="food-item border-1px" v-for="(food, f_index) in item.foods" :key="f_index" @click="selectFood(food, $event)">
                                <div class="icon">
        ...
        <food ref="food" :food="selectedFood" @cartAdd="cartAdd"></food>
    </div>
</template>
  ...
  export default {
    ...
    methods: {
        selectMenu(index, event) {
            ...
            this.foodsScroll.scrollToElement(ele, 300, 0, 1);
            // 此处需要加offsetY=1, 否则左侧点击定位不准
        },
        _initScroll() {
        ...
        cartAdd(target) {
            ...
            Vue.nextTick(function () { 
                that.$refs.shopcart.drop(target);
            });
        }
    }
  };
