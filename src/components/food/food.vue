        ...
        <div v-show="showFlag" class="food" ref="foodwrapper">
            <div class="food-content">
                ...
                <div class="rating">
                    ...
                    <ratingselect :selectType="selectType" :onlyContent="onlyContent" :desc="desc" :ratings="food.ratings" @ratingtypeSelect="ratingtypeSelect" @contToggle="contToggle"></ratingselect>
...
<script type="text/javascript">
    ...
    import {_formatDate} from '@/common/js/date';
        ...
        methods: {
            show() {
                ...
                this.$nextTick(function () {
                    if (!that.scroll) {
                        that.scroll = new BScroll(this.$refs.foodwrapper, {
                                            click: true,
                                            mouseWheel: true
                                        });
                    } else {
            ...
            addFood(target) { // 跟add关联的addFood方法
                this.$emit('cartAdd', target); // 触发当前实例food上的事件add(在goods组件上绑定在food组件的add方法)
            },
